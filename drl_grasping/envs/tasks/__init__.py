...
from .grasp import Grasp, GraspColorImage, GraspRgbdImage, GraspOctree
...
register(
    ...
    kwargs={'task_cls': GraspOctree,
            ...
            'verbose': False})
register(
    id='Grasp-ColorImage-Gazebo-v0',
    entry_point='gym_ignition.runtimes.gazebo_runtime:GazeboRuntime',
    max_episode_steps=GRASP_MAX_EPISODE_STEPS,
    kwargs={'task_cls': GraspColorImage,
            'agent_rate': GRASP_AGENT_RATE,
            'physics_rate': GRASP_PHYSICS_RATE,
            'real_time_factor': GRASP_RTF,
            'robot_model': 'ur5_rg2',
            ...
            'verbose': False})
register(
    id='Grasp-RgbdImage-Gazebo-v0',
    entry_point='gym_ignition.runtimes.gazebo_runtime:GazeboRuntime',
    max_episode_steps=GRASP_MAX_EPISODE_STEPS,
    kwargs={'task_cls': GraspRgbdImage,
            'agent_rate': GRASP_AGENT_RATE,
            'physics_rate': GRASP_PHYSICS_RATE,
            'real_time_factor': GRASP_RTF,
            'robot_model': 'ur5_rg2',
